...
def get_latest_price(ticker):
    ...
    # Buscar la sesión previa donde el precio fue mayor o igual al precio más reciente
    ...
    if not data_before_latest.empty:
        ...
        price_at_last_matched_date = float(price_at_last_matched_date)

        st.info(f"{ticker} - Precio en Fecha Previa: {price_at_last_matched_date} en {last_matched_date}")
...
# Ordenar la tabla por 'Días Desde'
